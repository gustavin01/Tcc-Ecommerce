...
export default function ProdFastFwd ({ data }) {
    const { products, setProducts, loading, setLoading } = useContext(AppContext);
    const [forceUpdate, setForceUpdate] = useState(false);
    const [product, setProduct] = useState();
    const selectedProductId = 81;
            ...
            <>
                ...
                <div className="product-page-container">
                    <span className="link-route">
                        <a href={'Home'}>Home</a> {'>'} <a href="#">Fast Fwd</a>
                    </span>
                    <section id="product-page">
                        <div className="product-page-img">
                            <div className="product">
                                <div>
                                    <div>
                                        <img src={n8} alt="Product image" js-selector="image-container" />
                                    </div>
                                </div>
                                <div>
                                    <button className="btnt active" js-class="image-button">
                                        <img src={n8} alt="Product Image" />
                                    </button>
                        ...
                        <div className="product-page-details">
                            ...
                            <p>O Tênis Puma Fast-FWD Nitro Elite Run 75 combina estilo e desempenho para corredores que buscam leveza e resposta. Com tecnologia Nitro Foam na entressola para amortecimento eficiente, proporciona uma corrida suave. Design moderno, materiais respiráveis e sola de borracha oferecem conforto e tração confiável. Ideal para quem busca um calçado esportivo funcional e elegante.</p>
                            <section>
                    ...
                    <section className="product-all-info">
                        ...
                        <div className="info-container materials">
                            <p>O <em>Tênis Fast-FWD Nitro Elite Run 75</em> é uma fusão arrojada de estilo e desempenho. Integrando a inovadora tecnologia Nitro Foam na entressola e um design moderno, este tênis é uma obra-prima para quem busca destacar-se na corrida urbana.</p>

                            <p>A parte superior do tênis apresenta um design contemporâneo, proporcionando conforto e ventilação durante a corrida. A tecnologia Nitro Foam na entressola oferece amortecimento eficiente, garantindo uma experiência suave. Detalhes como o logo Puma e a sola de borracha aderente complementam o design dinâmico.</p>

                            <p>Seja nas pistas de corrida ou em atividades casuais, o <em>Tênis Fast-FWD Nitro Elite Run 75</em> é um símbolo de ousadia e funcionalidade, atendendo aos desejos daqueles que buscam um calçado que vai além dos limites tradicionais do esporte.</p>
                        </div>
                        <div className="info-container howuse">
                            <p><strong>1. Parte Superior:</strong></p>
                            <ul>
                                <li>Design contemporâneo para conforto e ventilação.</li>
                            </ul>

                            <p><strong>2. Entressola:</strong></p>
                            <ul>
                                <li>Tecnologia Nitro Foam para amortecimento eficiente.</li>
                                <li>Detalhes do logo Puma para autenticidade da marca.</li>
                            </ul>

                            <p><strong>3. Sola:</strong></p>
                            <ul>
                                <li>Sola de borracha aderente para tração confiável.</li>
                                <li>Design dinâmico para complementar o estilo esportivo.</li>
                            </ul>

                            <p>O <em>Tênis Fast-FWD Nitro Elite Run 75</em> é a escolha perfeita para quem procura um calçado que une moda esportiva, desempenho e autenticidade, destacando-se nas pistas com um toque ousado.</p>
                        </div>
