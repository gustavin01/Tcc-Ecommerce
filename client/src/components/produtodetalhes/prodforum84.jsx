...
export default function ProdForum84({ data }) {
    const { products, setProducts, loading, setLoading } = useContext(AppContext);
    const [forceUpdate, setForceUpdate] = useState(false);
    const [product, setProduct] = useState();
    const selectedProductId = 80;
            ...
            <>
                ...
                <div className="product-page-container">
                    <span className="link-route">
                        <a href={'Home'}>Home</a> {'>'} <a href="#">Forum 84</a>
                    </span>
                    <section id="product-page">
                        <div className="product-page-img">
                            <div className="product">
                                <div>
                                    <div>
                                        <img src={n7} alt="Product image" js-selector="image-container" />
                                    </div>
                                </div>
                                <div>
                                    <button className="btnt active" js-class="image-button">
                                        <img src={n7} alt="Product Image" />
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div className="product-page-details">
                            ...
                            <p>O <em>Tênis Forum 84 High</em> é uma elegante combinação de estilo retrô e conforto moderno. Com seu design clássico e cano alto, oferece um visual atemporal, enquanto a tecnologia de amortecimento proporciona uma experiência agradável ao caminhar. Ideal para quem busca um toque vintage sem abrir mão do conforto.</p>
                            <section>
                    ...
                    <section className="product-all-info">
                        ...
                        <div className="info-container materials">
                            <p>O <em>Tênis Forum 84 High</em> é uma elegante combinação de estilo retrô e conforto moderno. Com seu design clássico e cano alto, oferece um visual atemporal, enquanto a parte superior proporciona conforto e ventilação. A entressola apresenta tecnologia de amortecimento, garantindo uma experiência suave, e detalhes como o logo Adidas e a sola de borracha aderente complementam o design icônico.</p>

                            <p>Seja em passeios urbanos ou em eventos casuais, o <em>Tênis Forum 84 High</em> é uma escolha ousada que atende aos desejos daqueles que buscam um calçado que une moda, praticidade e autenticidade.</p>
                        </div>
                        <div className="info-container howuse">
                            <p><strong>1. Parte Superior:</strong></p>
                            <ul>
                                <li>Design clássico e atemporal para conforto e ventilação.</li>
                            </ul>

                            <p><strong>2. Entressola:</strong></p>
                            <ul>
                                <li>Tecnologia de amortecimento para uma experiência suave.</li>
                                <li>Detalhes do logo Adidas para autenticidade da marca.</li>
                            </ul>

                            <p><strong>3. Sola:</strong></p>
                            <ul>
                                <li>Sola de borracha aderente para tração confiável.</li>
                                <li>Design icônico para um toque retrô e elegante.</li>
                            </ul>

                            <p>O <em>Tênis Forum 84 High</em> é a escolha perfeita para quem procura um calçado que destaca-se nas ruas com um toque vintage e conforto contemporâneo.</p>
                        </div>
                    </section>
                </div>
                <br />
