...
export default function ProdChuSpeed({ data }) {
    const { products, setProducts, loading, setLoading } = useContext(AppContext);
    const [forceUpdate, setForceUpdate] = useState(false);
    const [product, setProduct] = useState();
    const selectedProductId = 83;
            ...
            <>
                ...
                <div className="product-page-container">
                    <span className="link-route">
                        <a href={'Home'}>Home</a> {'>'} <a href="#">Chuteira X</a>
                    </span>
                    <section id="product-page">
                        <div className="product-page-img">
                            <div className="product">
                                <div>
                                    <div>
                                        <img src={n10} alt="Product image" js-selector="image-container" />
                                    </div>
                                </div>
                                <div>
                                    <button className="btnt active" js-class="image-button">
                                        <img src={n10} alt="Product Image" />
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div className="product-page-details">
                            ...
                            <p>A <em>Chuteira X Speedportal.3 Futsal</em> é projetada para proporcionar agilidade e precisão em quadras de futsal. Com um design aerodinâmico e materiais de alta qualidade, esta chuteira oferece performance excepcional para os amantes do esporte.</p>
                    ...
                    <section className="product-all-info">
                        ...
                        <div className="info-container materials">
                            <p>A <em>Chuteira X Speedportal.3 Futsal</em> é a escolha definitiva para jogadores de futsal que buscam excelência em agilidade e precisão. Combinando um design aerodinâmico com tecnologia avançada, esta chuteira oferece suporte e tração ideais para o ambiente dinâmico das quadras.</p>

                            <p>A parte superior da chuteira é confeccionada com materiais respiráveis e leves, proporcionando conforto e ajuste preciso. A sola, com padrão de tração específico para futsal, oferece aderência excepcional e mobilidade ágil. Detalhes como o logotipo X e o acabamento durável tornam esta chuteira uma opção confiável para os jogadores em busca de desempenho superior.</p>

                            <p>Seja para dribles rápidos, passes precisos ou chutes potentes, a <em>Chuteira X Speedportal.3 Futsal</em> eleva o jogo dos praticantes de futsal, proporcionando confiança e estilo nas quadras.</p>

                        </div>
                        <div className="info-container howuse">
                            <p><strong>1. Parte Superior:</strong></p>
                            <ul>
                                <li>Materiais respiráveis e leves para conforto e ajuste preciso.</li>
                                <li>Design aerodinâmico para agilidade em movimentos rápidos.</li>
                            </ul>

                            <p><strong>2. Sola:</strong></p>
                            <ul>
                                <li>Padrão de tração específico para futsal, oferecendo aderência excepcional.</li>
                                <li>Mobilidade ágil para movimentos rápidos e precisos.</li>
                            </ul>

                            <p><strong>3. Detalhes e Acabamento:</strong></p>
                            <ul>
                                <li>Logotipo X e acabamento durável para estilo e confiabilidade.</li>
                                <li>Projetada para destacar-se nas quadras de futsal.</li>
                            </ul>

                            <p>A <em>Chuteira X Speedportal.3 Futsal</em> é mais do que um equipamento esportivo; é uma ferramenta para elevar o desempenho e a confiança dos jogadores de futsal em cada partida.</p>
