...
export default function ProdJordan1({ data }) {
    const { products, setProducts, loading, setLoading } = useContext(AppContext);
    const [forceUpdate, setForceUpdate] = useState(false);
    const [product, setProduct] = useState();
    const selectedProductId = 79;
            ...
            <>
                ...
                <div className="product-page-container">
                    <span className="link-route">
                        <a href={'Home'}>Home</a> {'>'} <a href="#">Jordan 1</a>
                    </span>
                    <section id="product-page">
                        <div className="product-page-img">
                            <div className="product">
                                <div>
                                    <div>
                                        <img src={n6} alt="Product image" js-selector="image-container" />
                                    </div>
                                </div>
                                <div>
                                    <button className="btnt active" js-class="image-button">
                                        <img src={n6} alt="Product Image" />
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div className="product-page-details">
                            ...
                            <p>O <em>Tênis Air Jordan 1 Elevate High</em> combina estilo lendário e desempenho excepcional. Com design clássico e cano alto, oferece conforto e suporte. A entressola resiliente garante amortecimento eficaz, tornando-o perfeito para as ruas ou o jogo. Uma expressão definitiva de ousadia e autenticidade.</p>
                            <section>
                    ...
                    <section className="product-all-info">
                        ...
                        <div className="info-container materials">
                            <p>O <em>Tênis Air Jordan 1 Elevate High</em> é a fusão perfeita entre estilo lendário e conforto excepcional. Com design clássico e cano alto, proporciona um visual marcante, enquanto a parte superior assegura conforto e ventilação. A tecnologia de amortecimento na entressola oferece uma experiência suave, e os detalhes distintivos, como o logo Jordan, e a sola aderente complementam o design icônico.</p>

                            <p>Seja nas ruas ou em eventos casuais, o <em>Air Jordan 1 Elevate High</em> é uma escolha ousada, atendendo aos desejos daqueles que buscam moda, praticidade e autenticidade em um só calçado.</p>
                        </div>
                        <div className="info-container howuse">
                            <p><strong>1. Parte Superior:</strong></p>
                            <ul>
                                <li>Design clássico e marcante para conforto e ventilação.</li>
                            </ul>

                            <p><strong>2. Entressola:</strong></p>
                            <ul>
                                <li>Tecnologia de amortecimento para uma experiência suave.</li>
                                <li>Detalhes distintivos, incluindo o logo Jordan, para autenticidade.</li>
                            </ul>

                            <p><strong>3. Sola:</strong></p>
                            <ul>
                                <li>Sola aderente para tração confiável e design icônico.</li>
                            </ul>

                            <p>O <em>Tênis Air Jordan 1 Elevate High</em> é a escolha perfeita para quem procura um calçado que se destaca nas ruas, unindo estilo e conforto contemporâneo de forma audaciosa.</p>
                        </div>
