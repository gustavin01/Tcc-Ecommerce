...
export default function ProdTAdizero({ data }) {
    const { products, setProducts, loading, setLoading } = useContext(AppContext);
    const [forceUpdate, setForceUpdate] = useState(false);
    const [product, setProduct] = useState();
    const selectedProductId = 75;
            ...
            <>
                ...
                <div className="product-page-container">
                    <span className="link-route">
                        <a href={'Home'}>Home</a> {'>'} <a href="#">Adidas 00s</a>
                    </span>
                    <section id="product-page">
                        <div className="product-page-img">
                            <div className="product">
                                <div>
                                    <div>
                                        <img src={n2} alt="Product image" js-selector="image-container" />
                                    </div>
                                </div>
                                <div>
                                    <button className="btnt active" js-class="image-button">
                                        <img src={n2} alt="Product Image" />
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div className="product-page-details">
                            ...
                            <p>O <em>Tênis Adizero Adios Pro 3.0</em> é a escolha definitiva para corredores de elite em busca de velocidade e desempenho. Com tecnologia de ponta, este tênis oferece leveza, amortecimento responsivo e suporte estratégico para maximizar o desempenho em corridas de longa distância.</p>
                            <section>
                    ...
                    <section className="product-all-info">
                        ...
                        <div className="info-container materials">
                            <p>O <em>Tênis Adizero Adios Pro 3.0</em> representa a vanguarda em calçados de corrida, projetado para atender às demandas de corredores de elite. Este tênis é o resultado da combinação de tecnologia avançada, materiais premium e design inovador, proporcionando uma experiência de corrida incomparável.</p>

                            <p>A parte superior do Adios Pro 3.0 apresenta um material leve e respirável, proporcionando conforto e suporte precisos. A entressola conta com tecnologia de amortecimento responsivo, oferecendo retorno de energia a cada passo. A sola, com design estratégico, proporciona tração e estabilidade, permitindo uma corrida mais eficiente.</p>

                            <p>Seja para competições de alto nível ou treinos diários, o <em>Tênis Adizero Adios Pro 3.0</em> é a escolha para corredores que buscam o máximo desempenho, leveza e velocidade.</p>

                        </div>
                        <div className="info-container howuse">
                            <p><strong>1. Parte Superior:</strong></p>
                            <ul>
                                <li>Material leve e respirável para conforto e suporte.</li>
                                <li>Design inovador para ajuste preciso.</li>
                            </ul>

                            <p><strong>2. Entressola:</strong></p>
                            <ul>
                                <li>Tecnologia de amortecimento responsivo para retorno de energia.</li>
                                <li>Construção que proporciona suporte e estabilidade.</li>
                            </ul>

                            <p><strong>3. Sola:</strong></p>
                            <ul>
                                <li>Design estratégico para tração e estabilidade.</li>
                                <li>Materiais duráveis para resistência em corridas de longa distância.</li>
                            </ul>

                            <p>O <em>Tênis Adizero Adios Pro 3.0</em> é mais do que um calçado de corrida; é uma ferramenta projetada para impulsionar o desempenho e alcançar novos limites.</p>
