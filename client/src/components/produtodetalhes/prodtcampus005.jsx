...
export default function ProdTCampus00s ({ data }) {
    const { products, setProducts, loading, setLoading } = useContext(AppContext);
    const [forceUpdate, setForceUpdate] = useState(false);
    const [product, setProduct] = useState();
    const selectedProductId = 76;
            ...
            <>
                ...
                <div className="product-page-container">
                    <span className="link-route">
                        <a href={'Home'}>Home</a> {'>'} <a href="#">Campus 00S</a>
                    </span>
                    ...
                    <div className="product-page-img">
                            <div className="product">
                                <div>
                                    <div>
                                        <img src={n5} alt="Product image" js-selector="image-container" />
                                    </div>
                                </div>
                                <div>
                                    <button className="btnt active" js-class="image-button">
                                        <img src={n5} alt="Product Image" />
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div className="product-page-details">
                            ...
                            <p>O <em>Tênis Campus 00s</em> é uma reinterpretação moderna do estilo clássico dos anos 2000. Com design retrô e materiais de alta qualidade, este tênis oferece um visual urbano autêntico, combinando conforto e moda de forma única.</p>
                            <section>
                    ...
                    <section className="product-all-info">
                        ...
                        <div className="info-container materials">
                            <p>O <em>Tênis Campus 00s</em> é uma homenagem à estética icônica dos anos 2000, revitalizado com um toque moderno. Combinando estilo clássico e contemporâneo, este tênis é uma expressão autêntica de moda urbana.</p>

                            <p>A parte superior do Campus 00s apresenta materiais premium, proporcionando durabilidade e conforto. Seu design retrô, inspirado na moda da década de 2000, é acentuado por detalhes exclusivos. A sola, além de oferecer aderência, contribui para o apelo estilístico único deste calçado.</p>

                            <p>Disponível em uma variedade de cores, o <em>Tênis Campus 00s</em> é perfeito para quem busca um visual casual e descolado, relembrando a era dourada da cultura urbana.</p>

                        </div>
                        <div className="info-container howuse">
                            <p><strong>1. Parte Superior:</strong></p>
                            <ul>
                                <li>Materiais premium para durabilidade e conforto.</li>
                                <li>Design retrô com detalhes exclusivos.</li>
                            </ul>

                            <p><strong>2. Sola:</strong></p>
                            <ul>
                                <li>Aderência para estabilidade e conforto durante o uso.</li>
                                <li>Contribui para o apelo estilístico do tênis.</li>
                            </ul>

                            <p>O <em>Tênis Campus 00s</em> é uma escolha versátil para quem valoriza a fusão entre o clássico e o contemporâneo, destacando-se como um ícone de estilo na moda urbana.</p>
