...
export default function ProdDiscBlaze({ data }) {
    const { products, setProducts, loading, setLoading } = useContext(AppContext);
    const [forceUpdate, setForceUpdate] = useState(false);
    const [product, setProduct] = useState();
    const selectedProductId = 82;
            ...
            <>
                ...
                <div className="product-page-container">
                    <span className="link-route">
                        <a href={'Home'}>Home</a> {'>'} <a href="#">Disc Blaze</a>
                    </span>
                    <section id="product-page">
                        <div className="product-page-img">
                            <div className="product">
                                <div>
                                    <div>
                                        <img src={n9} alt="Product image" js-selector="image-container" />
                                    </div>
                                </div>
                                <div>
                                    <button className="btnt active" js-class="image-button">
                                        <img src={n9} alt="Product Image" />
                                    </button>
                        ...
                        <div className="product-page-details">
                            ...
                            <p>O <em>Tênis Disc Blaze Snake</em> é uma peça única que combina o sistema de fechamento Disc Blaze com um design arrojado de pele de cobra. Este tênis oferece estilo marcante e praticidade inovadora, proporcionando um toque de extravagância para os amantes da moda urbana.</p>
                            <section>
                    ...
                    <section className="product-all-info">
                        ...
                        <div className="info-container materials">
                            <p>O <em>Tênis Disc Blaze Snake</em> é uma expressão audaciosa de estilo e funcionalidade. Integrando o inovador sistema de fechamento Disc Blaze com um design de pele de cobra, este tênis é uma obra-prima para quem busca destacar-se na moda urbana.</p>

                            <p>A parte superior do tênis apresenta o característico padrão de pele de cobra, conferindo uma estética única. O sistema Disc Blaze, permitindo ajuste personalizado, proporciona praticidade e estilo. A entressola, com tecnologia de amortecimento, garante conforto durante o uso diário. Detalhes como o logo Puma e a sola robusta complementam o design extravagante.</p>

                            <p>Seja nas ruas da cidade ou em eventos sociais, o <em>Tênis Disc Blaze Snake</em> é um símbolo de ousadia e sofisticação, atendendo aos desejos daqueles que buscam um calçado que vai além dos limites tradicionais da moda.</p>

                        </div>
                        <div className="info-container howuse">
                            <p><strong>1. Parte Superior:</strong></p>
                            <ul>
                                <li>Design marcante de pele de cobra para uma estética única.</li>
                                <li>Sistema de fechamento Disc Blaze para ajuste personalizado.</li>
                            </ul>

                            <p><strong>2. Entressola:</strong></p>
                            <ul>
                                <li>Tecnologia de amortecimento para conforto diário.</li>
                                <li>Detalhes do logo Puma para autenticidade da marca.</li>
                            </ul>

                            <p><strong>3. Sola:</strong></p>
                            <ul>
                                <li>Sola robusta para durabilidade e estilo.</li>
                                <li>Design extravagante para complementar a estética única.</li>
                            </ul>

                            <p>O <em>Tênis Disc Blaze Snake</em> é a escolha perfeita para quem procura um calçado que une moda, praticidade e autenticidade, destacando-se nas ruas com um toque ousado.</p>
