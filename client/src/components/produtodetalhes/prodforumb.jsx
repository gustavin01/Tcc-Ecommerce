...
export default function ProdForumB({ data }) {
    const { products, setProducts, loading, setLoading } = useContext(AppContext);
    const [forceUpdate, setForceUpdate] = useState(false);
    const [product, setProduct] = useState();
    const selectedProductId = 77;
            ...
            <>
                ...
                <div className="product-page-container">
                    <span className="link-route">
                        <a href={'Home'}>Home</a> {'>'} <a href="#">Forum Bold</a>
                    </span>
                    <section id="product-page">
                        <div className="product-page-img">
                            <div className="product">
                                <div>
                                    <div>
                                        <img src={n4} alt="Product image" js-selector="image-container" />
                                    </div>
                                </div>
                                <div>
                                    <button className="btnt active" js-class="image-button">
                                        <img src={n4} alt="Product Image" />
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div className="product-page-details">
                            ...
                            <p>O <em>Tênis Forum Bold x André Saraiva</em> é uma colaboração exclusiva que combina o icônico Tênis Forum Bold com a visão criativa única de André Saraiva. Com design arrojado e detalhes artísticos, este tênis é uma expressão autêntica de estilo urbano contemporâneo.</p>
                            <section>
                    ...
                    <section className="product-all-info">
                        ...
                        <div className="info-container materials">
                            <p>O <em>Tênis Forum Bold x André Saraiva</em> é uma colaboração única que funde a atitude ousada do Tênis Forum Bold com a visão artística distinta de André Saraiva. Este tênis vai além dos limites convencionais, oferecendo uma fusão inovadora de moda e arte urbana.</p>

                            <p>A parte superior do tênis apresenta materiais premium, garantindo durabilidade e estilo. Os detalhes artísticos criados por André Saraiva, desde a língua até a sola, acrescentam uma camada única de expressão criativa. Além do design impactante, o tênis proporciona conforto e estabilidade.</p>

                            <p>Edição limitada e disponível em diferentes variantes, o <em>Tênis Forum Bold x André Saraiva</em> é uma peça de coleção para aqueles que buscam um calçado que transcenda as barreiras entre moda, arte e autenticidade urbana.</p>
                        ...
                        <div className="info-container howuse">
                            ...
                            <ul>
                                ...
                                <li>Detalhes artísticos criados por André Saraiva.</li>
                            </ul>

                            <p><strong>2. Sola:</strong></p>
                            <ul>
                                <li>Conforto aliado à expressão única da colaboração.</li>
                                <li>Design impactante e estável para uso urbano.</li>
                            </ul>

                            <p>O <em>Tênis Forum Bold x André Saraiva</em> é uma declaração de estilo e criatividade, representando a união entre o legado do Tênis Forum Bold e a inovação artística de André Saraiva.</p>
